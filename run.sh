...
export GIT_REPO_URL="https://github.com/helpfultangent/semantic-bridge-demo.git"
export COOKBOOK_NAME="semantic-bridge-demo"
export COOKBOOK_CONDA_ENV="semantic-SVO"
IS_GPU_JOB=false
